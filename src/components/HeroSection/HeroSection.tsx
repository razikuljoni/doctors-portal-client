...
const HeroSection = () => (
    <Carousel autoplay>
        <div>
            <h3 style={contentStyle}>
                ...
                <Row className="container mx-auto">
                            ...
                            <div className="flex items-center px-5 py-24 ">
                                <div className=" flex flex-col  md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                                    ...
                                    <p className="mb-8 leading-relaxed">
                                        Copper mug try-hard pitchfork pour-over
                                        freegan heirloom neutra air plant
                                        cold-pressed tacos poke beard tote bag.
                                        Heirloom echo park mlkshk tote bag
                                        selvage hot chicken authentic tumeric
                    ...
                    <Col sm={24} md={12} className="flex justify-end w-full">
                        <Image
                            src={doctors}
                            layout="responsive"
                            alt="Hero Image"
        ...
        {/* <div>
            <h3 style={contentStyle}>This is Doctors Portal</h3>
        </div>
        <div>
            <h3 style={contentStyle}>This is Doctors Portal</h3>
        </div>
